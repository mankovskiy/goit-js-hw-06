...
// элементов < img > вложенных в < li >. Для
// создания разметки используй шаблонные строки
...
const newGallryItem = images.map(createNewImages).join("");
myGallery.insertAdjacentHTML("afterbegin", newGallryItem);
